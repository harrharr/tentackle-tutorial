...
/**
 * Persistence interface for {@link ${pdoInterface}}.
 */
<#if pdoInheritance != "NONE" && pdoInheritance != "EMBEDDED">
public interface ${persistenceInterface}<T extends ${pdoInterface}<T>>
       extends ${superPersistenceInterface}<T> {
<#else>
public interface ${persistenceInterface}
       extends ${superPersistenceInterface}<${pdoInterface}> {
</#if>
